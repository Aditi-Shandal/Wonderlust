...
CREATE POLICY "Anyone can read stories" ON public.community_stories FOR SELECT USING (true);
CREATE POLICY "Auth users can create stories" ON public.community_stories FOR INSERT WITH CHECK (auth.uid() = user_id);
